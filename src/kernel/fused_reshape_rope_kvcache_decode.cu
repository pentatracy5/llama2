...
template <typename T>
__global__ void fused_reshape_rope_kvcache_decode_kernel(const unsigned int batch_size,
                                              ...
                                              Tensor<T> &v)
{
    ...
    CUDA_LAUNCH(fused_reshape_rope_kvcache_decode_kernel, n_threads, threads_per_block)(batch_size,
                                                                                        kv_cache_len,
                                                                                        q_head_num,
                                                                                        kv_head_num,
                                                                                        head_dim,
